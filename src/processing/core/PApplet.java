    ...
    public void pixelDensity(int density) {
        ...
        if (density != this.pixelDensity) {
            if (insideSettings("pixelDensity", density)) {
                ...
                if (!(FX2D.equals(renderer) || FX3D.equals(renderer)) && density == 2 && displayDensity() == 1) {
...
//  }
  ...
  */
     ...
     * @nowebref
     */
    public static int color(float fgray) {
        if (g == null) {
            int gray = (int) fgray;
            if (gray > 255) gray = 255;
            else if (gray < 0) gray = 0;
     ...
     * @nowebref
     */
    public static int color(float fgray, float falpha) {
        if (g == null) {
            int gray = (int) fgray;
    ...
    public static int color(int v1, int v2, int v3, int alpha) {
        if (g == null) {
            if (alpha > 255) alpha = 255;
            else if (alpha < 0) alpha = 0;
            if (v1 > 255) v1 = 255;
...
//    // If the applet doesn't call for fullscreen, but the command line does,
