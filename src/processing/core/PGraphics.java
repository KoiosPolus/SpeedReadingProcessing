...
import processing.opengl.PShader;
   ...
   *
   * controller.Main graphics and rendering context, as well as the base API
   ...
   *
   * <h3>Advanced</h3>
   * controller.Main graphics and rendering context, as well as the base API implementation.
   *
